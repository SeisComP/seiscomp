...
MACRO(SC_ADD_CHANGELOG _app)
	IF(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.md")
		INSTALL(FILES ${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.md DESTINATION ${SC3_PACKAGE_SHARE_DIR}/doc/${_app} RENAME CHANGELOG)
	ELSE(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.md")
		IF(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.rst")
			INSTALL(FILES ${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.rst DESTINATION ${SC3_PACKAGE_SHARE_DIR}/doc/${_app})
		ELSE(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.rst")
			IF(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG")
				INSTALL(FILES ${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG DESTINATION ${SC3_PACKAGE_SHARE_DIR}/doc/${_app})
			ENDIF(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG")
		ENDIF(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.rst")
